...
- **descendant**: any superordinate spawned beneath you (children, grandchildren, ...)
- **ancestor**: your parent context, grandparent, etc.
- **sibling**: another context that shares your immediate `sup_parent`
